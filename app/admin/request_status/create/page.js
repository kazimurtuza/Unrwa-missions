...
function DepartmentCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const response = await axiosClient.post('request_status', postData);
        // Check if the response contains data
        console.log(response);
        if (response && response.data) {
          if(response.data.success==true)
          {
            setSuccessMessage("Request Status Create Successfully");
            setRequest_status("");
            setAbbrevation("");
            setErrorMessage("");
          }
                ...
                <div className="container mx-auto py-8">
                  <div className="w-5/6 mx-auto bg-white rounded shadow">
                    <div className="p-8">
                      ...
                      Missions Request Status Create
                      </p>
                      <br></br>
                      {successMessage && (
                        <div
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          id="categoryName"
                          type="text"
                          placeholder="Enter your request status"
