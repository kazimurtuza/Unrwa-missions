...
function UmrahList() {
    ...
    useEffect(() => {}, []); // Empty dependency array means this effect runs only once, similar to componentDidMount
                ...
                ? umrah.map((item, index) => (
                    ...
                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <p className="text-gray-900 whitespace-no-wrap">
                          ...
                          <td
                              className='relative px-5 py-5 border-b border-gray-200 bg-white text-sm text-right'
