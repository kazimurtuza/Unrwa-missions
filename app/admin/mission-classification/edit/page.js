...
function MissionClassificationEdit() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const { data } = await axiosClient.get(`misson-classification/${id}`);
                console.log(data);
                setRequests_classifications(data.result.requests_classifications);
                setAbbreviation(data.result.abbreviation);
            } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const response = await axiosClient.put(`misson-classification/${id}`, postData);
        // Check if the response contains data
        console.log(response);
        if (response && response.data) {
          if(response.data.success==true)
          {
            setSuccessMessage("Mission Classification update Successfully");
...
export default MissionClassificationEdit;
