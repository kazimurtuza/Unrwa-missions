...
function MissionClassificationList() {
    ...
    const body = (
        <>
            {Array.isArray(missionClassification) &&
                missionClassification.map((item, index) => (
                    <tr key={index}>
                        ...
                        >
                            <Link
                                href={{
                                    pathname:
                                        "/admin/mission-classification/edit",
                                    query: { id: item._id },
                                }}
                                    ...
                                    if (confirmed) {
                                        ...
                                        try {
                                            await axiosClient.delete(
                                                `misson-classification/${item._id}`,
                                                {
                                                    method: "DELETE",
                                                    headers: {
                                                        "Content-Type":
...
export default MissionClassificationList;
