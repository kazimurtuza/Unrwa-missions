...
function Driver() {
    ...
    let tableName = "Driver";
    const headName = ["Si", "Name", "Email", "Driver ID", "Jawwal Phone", "Ooredo Phone", "Whatsapp Number", "Action"];
    let head = (
        <tr>
    ...
    const body = (
        <>
            {Array.isArray(driver) && driver.map((item, index) => (
