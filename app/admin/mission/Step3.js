...
const Step3 = ({data, vehicleStore, emptyVehicle, checkValidation, vehicleStaff, vehicleStaffStore}) => {
    ...
    return (
        <div className="w-full mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-14">
            ...
            {vehicleList.map((item, index) => <Collapsable2 info={item} vehicleStaff={vehicleStaff}
                                                            checkValidation={checkValidation} setInfo={handleChange}
                                                            item={index} vehicleStaffStore={vehicleStaffStore}/>)}
