  ...
  return ReactFiberReconciler({
    ...
    createInstance: function createInstance(type, _ref2) {
      var style = _ref2.style;
        _ref2.children;
        var props = _objectWithoutPropertiesLoose__default.default(_ref2, _excluded$2);
      return {
        type: type,
        box: {},
        style: style || {},
 ...
 */
var usePDF = function usePDF(_temp) {
  ...
  var update = require$$1.useCallback(function (newDoc) {
...
var _excluded = ["fileName", "document", "children", "onClick", "href"];
var PDFDownloadLink = function PDFDownloadLink(_ref) {
  var _ref$fileName = _ref.fileName,
    ...
    _ref.href;
    var rest = _objectWithoutPropertiesLoose__default.default(_ref, _excluded);
  var _usePDF = usePDF(),
    instance = _usePDF[0],
    updateInstance = _usePDF[1];
  require$$1.useEffect(function () {
  ...
  return /*#__PURE__*/jsxRuntime.jsx("a", _extends__default.default({
    href: instance.url,
    download: fileName,
    onClick: handleClick
  }, rest, {
